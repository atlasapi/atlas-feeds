...
public class TVAnytimeElementFactoryTest {
    ...
    public void testGenerationOfTrueFlagType() {
        FlagType trueFlag = TvAnytimeElementFactory.flag(true);
    ...
    public void testGenerationOfFalseFlagType() {
        FlagType falseFlag = TvAnytimeElementFactory.flag(false);
    ...
    public void testGenerationOfGregorianCalendarFromDateTime() {
        XMLGregorianCalendar calendar = TvAnytimeElementFactory.gregorianCalendar(clock.now());
    ...
    public void testGenerationJavaxDurationFromJodaDuration() {
        ...
        javax.xml.datatype.Duration generated = TvAnytimeElementFactory.durationFrom(duration);
