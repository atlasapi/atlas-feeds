...
public class LakeviewFeedCompilerTest {
	...
	public void testBrandAtomUri() {
		LakeviewFeedCompiler feedCompiler = new LakeviewFeedCompiler();
		assertEquals("http://www.channel4.com/pmlsd/educating-essex/4od.atom", 
	...
	public void testSeriesAtomUri() {
		LakeviewFeedCompiler feedCompiler = new LakeviewFeedCompiler();
		assertEquals("http://www.channel4.com/pmlsd/educating-essex/4od.atom#series-1", 
	...
	public void testEpisodeAtomUri() {
		LakeviewFeedCompiler feedCompiler = new LakeviewFeedCompiler();
		assertEquals("http://www.channel4.com/pmlsd/educating-essex/4od.atom#12345", 
