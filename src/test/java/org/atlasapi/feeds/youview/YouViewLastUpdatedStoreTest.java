...
public class YouViewLastUpdatedStoreTest {
    ...
    public void testDeltaWontRunIfNoLastUpdatedRecord() throws HttpException {
        YouViewUploadTask task = new YouViewUploadTask(youViewClient, lastUpdatedContentFinder, store, Publisher.LOVEFILM, false, Mockito.mock(TransactionStore.class));
        task.run();
    ...
    public void testBootstrapOnlySetsLastUpdatedForItsOwnPublisher() throws HttpException {
        ...
        YouViewUploadTask task = new YouViewUploadTask(youViewClient, lastUpdatedContentFinder, store, Publisher.LOVEFILM, true, Mockito.mock(TransactionStore.class));
        task.run();
