...
//        YouViewUploadTask task = new YouViewUploadTask(youViewClient, lastUpdatedContentFinder, store, Publisher.LOVEFILM, false, Mockito.mock(TaskStore.class), Mockito.mock(FeedStatisticsStore.class));
//        task.run();
...
//        YouViewUploadTask task = new YouViewUploadTask(youViewClient, lastUpdatedContentFinder, store, Publisher.LOVEFILM, true, Mockito.mock(TaskStore.class), Mockito.mock(FeedStatisticsStore.class));
//        task.run();
