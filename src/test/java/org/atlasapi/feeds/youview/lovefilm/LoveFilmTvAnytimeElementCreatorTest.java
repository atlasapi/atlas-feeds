...
public class LoveFilmTvAnytimeElementCreatorTest {
    ...
    private final TvAnytimeElementCreator elementCreator = new LoveFilmTvAnytimeElementCreator(
            progInfoGenerator, 
            groupInfoGenerator, 
            onDemandGenerator,
            contentHierarchy, 
    ...
    @Test
    public void testNoBroadcastEventElementCreatedForItem() {
        Item item = createItem("itemUri");
        
        Iterable<BroadcastEventType> broadcastEvents = elementCreator.createBroadcastEventElementsFor(item);
