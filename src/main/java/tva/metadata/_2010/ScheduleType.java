 ...
 *       &lt;sequence>
 *         &lt;element name="ScheduleEvent" type="{urn:tva:metadata:2010}ScheduleEventType" maxOccurs="unbounded"/>
 *       &lt;/sequence>
...
public class ScheduleType {
    ...
    @XmlElement(name = "ScheduleEvent", required = true)
    protected List<ScheduleEventType> scheduleEvent;
     ...
     * {@link ScheduleEventType }
     * 
     * 
     */
    public List<ScheduleEventType> getScheduleEvent() {
        if (scheduleEvent == null) {
            scheduleEvent = new ArrayList<ScheduleEventType>();
        }
