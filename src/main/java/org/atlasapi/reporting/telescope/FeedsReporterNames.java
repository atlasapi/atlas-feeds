...
public enum FeedsReporterNames implements TelescopeReporterName {
    ...
    YOU_VIEW_AUTOMATIC_UPLOADER_AMAZON("youview.automatic-uploader.amazon", "YouView Auto Uploader (Amazon)"),
    YOU_VIEW_AUTOMATIC_UPLOADER_NITRO("youview.automatic-uploader.nitro", "YouView Auto Uploader (Nitro)"),
