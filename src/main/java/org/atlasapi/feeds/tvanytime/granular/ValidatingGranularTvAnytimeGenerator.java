...
import org.atlasapi.feeds.youview.upload.JaxbErrorHandler;
import org.atlasapi.feeds.youview.upload.ValidationErrorType;
...
public class ValidatingGranularTvAnytimeGenerator implements GranularTvAnytimeGenerator {
    
    private final GranularTvAnytimeGenerator delegate;
    private final JAXBContext context;
    private final JaxbErrorHandler errorHandler;
    private final Validator validator;
    
    public ValidatingGranularTvAnytimeGenerator(GranularTvAnytimeGenerator delegate) 
