...
public class LoveFilmTvAnytimeElementCreator implements TvAnytimeElementCreator {
    ...
    public LoveFilmTvAnytimeElementCreator(ProgramInformationGenerator progInfoGenerator, 
