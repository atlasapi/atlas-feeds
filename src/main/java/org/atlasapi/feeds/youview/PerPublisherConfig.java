...
public class PerPublisherConfig {
    ...
    public static final Map<Publisher, FeedsReporterNames> TO_TELESCOPE_REPORTER_NAME = ImmutableMap.of(
            ...
            Publisher.AMAZON_UNBOX, FeedsReporterNames.YOU_VIEW_AUTOMATIC_UPLOADER_UNBOX,
            Publisher.AMAZON_V3, FeedsReporterNames.YOU_VIEW_AUTOMATIC_UPLOADER_AMAZON
    );

    public static final Map<Publisher, String> TO_APP_ID_MAP = ImmutableMap.of(
            Publisher.BBC_NITRO, "jmd", //not in use, equiv not running for nitro. But this needs to be something valid for proper startup.
            Publisher.AMAZON_UNBOX, Configurer.get("YOUVIEW_UPLOAD_UNBOX_EQUIVAPPID").get(),
            Publisher.AMAZON_V3, "jmd"
    );
}
