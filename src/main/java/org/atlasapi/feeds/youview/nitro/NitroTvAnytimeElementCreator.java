...
public class NitroTvAnytimeElementCreator implements TvAnytimeElementCreator {
    ...
    public NitroTvAnytimeElementCreator(ProgramInformationGenerator progInfoGenerator, 
