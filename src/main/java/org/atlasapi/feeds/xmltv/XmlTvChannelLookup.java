...
public class XmlTvChannelLookup extends ForwardingMap<Integer, Channel> {
    ...
    private static final ImmutableMap<Integer, Channel> delegate = ImmutableMap
            ...
            //            .put(106, Channel.BBC_TWO_EAST)
            //            .put(107, Channel.BBC_TWO_LONDON)
            //            .put(108, Channel.BBC_TWO_MIDLANDS)
            //            .put(109, Channel.BBC_TWO_NORTH_WEST)
            //            .put(110, Channel.BBC_TWO_NORTH)
            //            .put(111, Channel.BBC_TWO_NORTH_EAST)
            .put(112, Channel.BBC_TWO_NORTHERN_IRELAND)
            .put(113, Channel.BBC_TWO_SCOTLAND)
            .put(114, Channel.BBC_TWO_WALES)
            //            .put(115, Channel.BBC_TWO_SOUTH)
            //            .put(116, Channel.BBC_TWO_SOUTH_WEST)
            //            .put(117, Channel.BBC_TWO_WEST)
            .put(119, Channel.BIO)
            ...
            // .put(266, Channel.SKY_REAL_LIVES)
            ...
            //.put(2162, Channel.SKY_REAL_LIVES_HD)
            ...
            //.put(2252, Channel.MUSIC_CHOICE_BLUES)
            //.put(2253, Channel.MUSIC_CHOICE_CLASSICAL)
            //.put(2254, Channel.MUSIC_CHOICE_COUNTRY)
            //.put(2255, Channel.MUSIC_CHOICE_DANCE)
            //.put(2256, Channel.MUSIC_CHOICE_EASY_LISTENING)
            //.put(2257, Channel.MUSIC_CHOICE_GOLD)
            //.put(2258, Channel.MUSIC_CHOICE_HITS)
            //.put(2259, Channel.MUSIC_CHOICE_JAZZ)
            //.put(2260, Channel.MUSIC_CHOICE_LOVE)
            //.put(2261, Channel.MUSIC_CHOICE_ROCK)
            //.put(2264, Channel.SAT_1)
            .put(2331, Channel.GMTV_DIGITAL)
            //.put(2421, Channel.ASIA_1)
            //.put(2422, Channel.THE_PAKISTANI_CHANNEL)
