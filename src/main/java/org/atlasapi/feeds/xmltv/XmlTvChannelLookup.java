...
public class XmlTvChannelLookup extends ForwardingMap<Integer, Channel> {
    ...
    private static final ImmutableMap<Integer, Channel> delegate = ImmutableMap
            ...
            .put(421, Channel.PLAYHOUSE_DISNEY)//AKA Disney Junior
            ...
            .put(1261, Channel.SKY_BOX_OFFICE_DIGITAL)//AKA Sky Movies Box Office
            .put(1421, Channel.E_EXLAMATION)//AKA E! Entertainment
            .put(1461, Channel.FX)
            ...
            .put(2210, Channel.SKY_MOVIES_CHRISTMAS_CHANNEL)
            .put(2211, Channel.SKY_MOVIES_CHRISTMAS_CHANNEL_HD)
            ...
            .put(2585, Channel.LIVING_HD) //AKA Sky Living HD
            ...
            .put(2647, Channel.SKY_3_PLUS1)//Pick TV +1
