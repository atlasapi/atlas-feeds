...
public class RadioPlayerOdUploadTask extends RadioPlayerUploadTask {
    ...
    public RadioPlayerOdUploadTask(Iterable<FileUploadService> remoteTargets, Optional<DateTime> since, LocalDate day, RadioPlayerService service, Set<String> uris, AdapterLog log) {
        super(OD, remoteTargets, new RadioPlayerOdFeedSpec(service, day, since, uris), log);
    }
