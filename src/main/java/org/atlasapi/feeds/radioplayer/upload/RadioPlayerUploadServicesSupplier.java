 ...
 *
 */
public abstract class RadioPlayerUploadServicesSupplier {
    ...
    public RadioPlayerUploadServicesSupplier(String s3ServiceId, String s3Bucket, UsernameAndPassword s3Credentials, AdapterLog log, XMLValidator validator) {
    ...
    abstract Iterable<FileUploadService> get(DateTime uploadTime, FileType type);
     ...
     * @return
     */
    protected FileUploadService createServiceWithLoggingAndValidation(String serviceId, FileUploader uploader) {
     ...
     * @return
     */
    protected FileUploadService createS3UploadService(String uploaderType, DateTime uploadTime, FileType type) {
