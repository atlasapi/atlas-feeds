...
public abstract class RadioPlayerUploadServicesSupplier {
    ...
    public RadioPlayerUploadServicesSupplier(boolean uploadToS3Only, String s3ServiceId, String s3Bucket, UsernameAndPassword s3Credentials, AdapterLog log, XMLValidator validator) {
